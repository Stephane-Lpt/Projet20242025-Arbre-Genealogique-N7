...
procedure TestBinaryTree is
   ...
   begin
      ...
      addNode
        (Tree1, Tree2, 1, LEFT);  -- Ajoute Tree2 comme enfant gauche de Tree1
      addNode
        (Tree1, Tree3, 1, RIGHT); -- Ajoute Tree3 comme enfant droit de Tree1
      addNode
        (Tree3, Tree4, 3, LEFT);  -- Ajoute Tree4 comme enfant gauche de Tree3
      addNode
        (Tree4, Tree5, 4, RIGHT); -- Ajoute Tree5 comme enfant droit de Tree4
   ...
   begin
      ...
      pragma Assert
        (not isEmpty (Tree2), "Échec: Tree2 ne devrait pas être vide");
   ...
   begin
      ...
      pragma Assert
        (getLeftChild (RootTree) = LeftTree,
         "Erreur: Enfant gauche non trouvé");
      pragma Assert
        (getRightChild (RootTree) = RightTree,
         "Erreur: Enfant droit non trouvé");
      pragma Assert
        (getKey (getLeftChild (RootTree)) = 2,
         "Erreur: Clé de l'enfant gauche incorrecte");
      pragma Assert
        (getElement (getLeftChild (RootTree)) = 82,
         "Erreur: Valeur de l'enfant gauche incorrecte");
      pragma Assert
        (getKey (getRightChild (RootTree)) = 3,
         "Erreur: Clé de l'enfant droit incorrecte");
      pragma Assert
        (getElement (getRightChild (RootTree)) = 23,
         "Erreur: Valeur de l'enfant droit incorrecte");
      ...
      pragma Assert
        (getLeftChild (SubTree) = NewChild,
         "Erreur: Enfant gauche non ajouté au sous-arbre");
      pragma Assert
        (getKey (getLeftChild (SubTree)) = 4,
         "Erreur: Clé de l'enfant gauche incorrecte");
      pragma Assert
        (getElement (getLeftChild (SubTree)) = 45,
         "Erreur: Valeur de l'enfant gauche incorrecte");
      ...
      Put_Line ("Vérification de l'ajout");
      pragma Assert
        (getRightChild (SubTree) = NewChild,
         "Erreur: Enfant droit non ajouté au sous-arbre");
      pragma Assert
        (getKey (getRightChild (SubTree)) = 5,
         "Erreur: Clé de l'enfant droit incorrecte");
      pragma Assert
        (getElement (getRightChild (SubTree)) = 99,
         "Erreur: Valeur de l'enfant droit incorrecte");
   ...
   begin
      ...
      pragma Assert
        (isPresent (RootTree, 1), "Erreur: Racine (clé 1) non trouvée");
      pragma Assert
        (isPresent (RootTree, 2), "Erreur: Enfant gauche (clé 2) non trouvé");
      pragma Assert
        (isPresent (RootTree, 3), "Erreur: Enfant droit (clé 3) non trouvé");
      Put_Line ("Succès: Toutes les clés existantes sont présentes");

      Put_Line ("Vérification d'une clé absente");
      pragma Assert
        (not isPresent (RootTree, 4), "Erreur: Clé 4 trouvée dans l'arbre");
   ...
   begin
      ...
      initTree (Tree1);
      pragma Assert
        (getSize (Tree1) = 0, "Erreur: Taille de l'arbre vide non nulle");
      ...
      pragma Assert
        (getSize (Tree1) = 1,
         "Erreur: Taille de l'arbre avec racine incorrecte");
      ...
      pragma Assert
        (getSize (Tree1) = 3,
         "Erreur: Taille après ajout des enfants incorrecte");
      ...
      pragma Assert
        (getSize (Tree1) = 5,
         "Erreur: Taille après ajout des petits-enfants incorrecte");
      Put_Line ("Succès: Taille finale de l'arbre correcte");
   end TestGetSize;

   -- TEST getNode --
   procedure TestGetNode is
      Tree1, Tree2, Tree3, Tree4, Tree5, FoundRootTree, FoundChildTree,
      NotFoundTree : T_BinaryTree;
   begin
      Put_Line ("");
      ...
      pragma Assert
        (isEmpty (NotFoundTree), "Erreur: Un nœud inexistant a été retourné");
   ...
   begin
      ...
      pragma Assert
        (Stop_Flag, "Test 1 échoué: Le parcours n'a pas trouvé la clé 1");
      Put_Line
        ("Test 1 réussi: Le parcours s'est arrêté directement après avoir trouvé l'origine (clé 1)");
      ...
      -- Vérifier si le flag Stop a été mis à True
      pragma Assert
        (Stop_Flag, "Test 2 échoué: Le parcours n'a pas trouvé la clé 3.");
      Put_Line
        ("Test 2 réussi: Le parcours s'est arrêté directement après avoir trouvé la clé 3.");
      ...
      -- Vérifier si le flag Stop a été mis à True
      pragma Assert
        (Stop_Flag, "Test 3 échoué: Le parcours n'a pas trouvé la clé 5.");
      Put_Line
        ("Test 3 réussi: Le parcours s'est arrêté directement après avoir trouvé la clé 5.");
      ...
      traverseTreeAndApply
        (Tree1, ABRParent, NoStopActionExample'Access, Stop_Flag);

      -- Vérifier si le flag Stop est resté False
      pragma Assert
        (not Stop_Flag,
         "Test 4 échoué: La clé 99 a été trouvée alors qu'elle n'existe pas.");
      Put_Line
        ("Test 4 réussi: La clé 99 n'existe pas dans l'arbre donc le parcours ne s'est jamais arrêté.");
   ...
   begin
      ...
      pragma Assert
        (isEmpty (getNode (Tree1, 5)),
         "Test 1 échoué: Le nœud feuille (clé 5) est toujours présent.");
      pragma Assert
        (not isEmpty (getNode (Tree1, 4)),
         "Test 1 échoué: Un autre noeud a été supprimé.");
      pragma Assert
        (not isEmpty (getNode (Tree1, 3)),
         "Test 1 échoué: Un autre noeud a été supprimé.");
      pragma Assert
        (not isEmpty (getNode (Tree1, 2)),
         "Test 1 échoué: Un autre noeud a été supprimé.");
      pragma Assert
        (not isEmpty (getNode (Tree1, 1)),
         "Test 1 échoué: Un autre noeud a été supprimé.");

      -- TODO: Problem with deleteNodeRecursive
      Put_Line
        ("Test 1 réussi: Le nœud feuille (clé 5) a été supprimé correctement.");
      ...
      pragma Assert
        (isEmpty (getNode (Tree1, 5)),
         "Test 2 échoué: Le nœud avec sous-arbre (clé 3) est toujours présent.");
      pragma Assert
        (isEmpty (getNode (Tree1, 3)),
         "Test 2 échoué: Le nœud avec sous-arbre (clé 3) est toujours présent.");
      pragma Assert
        (isEmpty (getNode (Tree1, 4)),
         "Test 2 échoué: Le nœud avec sous-arbre (clé 3) est toujours présent.");
      pragma Assert
        (not isEmpty (getNode (Tree1, 2)),
         "Test 2 échoué: Un autre noeud a été supprimé.");
      pragma Assert
        (not isEmpty (getNode (Tree1, 1)),
         "Test 2 échoué: Un autre noeud a été supprimé.");

      Put_Line
        ("Test 2 réussi: Le nœud avec sous-arbre (clé 3) a été supprimé correctement.");
      ...
      pragma Assert
        (isEmpty (getNode (Tree1, 1)),
         "Test 3 échoué: La racine (clé 1) est toujours présente.");
      pragma Assert
        (isEmpty (getNode (Tree1, 2)),
         "Test 3 échoué: Un noeud de l'arbre est toujours présente.");
      pragma Assert
        (isEmpty (getNode (Tree1, 3)),
         "Test 3 échoué: Un noeud de l'arbre est toujours présente.");
      pragma Assert
      ...
      Put_Line
        ("Test 3 réussi: La racine (clé 1) a été supprimée correctement.");

      -- Test 4: Suppression d'un noeud qui n'existe pas (clé 99)
      Put_Line ("Test 4: Suppression d'un noeud qui n'existe pas (clé 99)");

      Tree1 := createOrdinaryTree;
      deleteNodeRecursive (Tree1, 5_000);

   exception
      when Absent_Key_Exception =>
         pragma Assert
           (not isEmpty (getNode (Tree1, 1)),
            "Test 4 échoué: Un autre noeud a été supprimé alors que rien ne devait être supprimé puisque la clé 99 n'existe pas.");
         pragma Assert
           (not isEmpty (getNode (Tree1, 2)),
            "Test 4 échoué: Un autre noeud a été supprimé alors que rien ne devait être supprimé puisque la clé 99 n'existe pas.");
         pragma Assert
         ...
         pragma Assert
           (not isEmpty (getNode (Tree1, 4)),
            "Test 4 échoué: Un autre noeud a été supprimé alors que rien ne devait être supprimé puisque la clé 99 n'existe pas.");
         pragma Assert
           (not isEmpty (getNode (Tree1, 5)),
            "Test 4 échoué: Un autre noeud a été supprimé alors que rien ne devait être supprimé puisque la clé 99 n'existe pas.");
         Put_Line
           ("Test 4 réussi: L'exception Absent_Key_Exception a été levée comme prévu et aucun noeud de l'arbre a été supprimé !");
      when others               =>
         Put_Line
           ("Test 4 réussi: L'exception Absent_Key_Exception a été levée comme prévu !");

         Put_Line
           ("Test 4 réussi: Aucun noeud n'a été supprimé car la clé 99 n'existe pas.");
